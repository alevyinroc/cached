...
insert into log_types (logtypedesc,CountsAsFind) values ('Found It',1);
insert into log_types (logtypedesc,CountsAsFind) values ('Attended',1);
insert into log_types (logtypedesc,CountsAsFind) values ('Webcam Photo Taken',1);