...
insert into Centerpoints(locationname,latitude,Longitude) values (
	'Greenwich',0,0
);
...
declare @p1 geography
SELECT @p1 = latlong from CenterPoints where locationname='Greenwich';
SELECT locationname, @p1.STDistance(latlong)/1000 as [Distance from home],latitude,Longitude from CenterPoints order by [Distance from home];