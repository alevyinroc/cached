...
CountryId,Elevation,StateId,CountyId, CorrectedLatitude,CorrectedLongitude) 
...
, convert(decimal, convert(varchar(20), coalesce(c.kbeforelat,c.latoriginal, c.latitude))) as latitude
, convert(decimal, convert(varchar(20), coalesce(c.kbeforelon,c.lonoriginal, c.longitude))) as longitude
,c.lastGPXDate as lastupdated
, c.placeddate as placed
, c.placedby as placedby
,PT.typeid
