...
select top 1 * from #foundmultis where cachename like 'm%' 
union
select top 1 * from #foundmultis where cachename like 'u%' 
union
...
union
select top 1 * from #foundmultis where cachename like 'c%' 
union
select top 1 * from #foundmultis where cachename like 'a%' and cachename not like 'a %' and cachename <> 'a' 
union
select top 1 * from #foundmultis where cachename like 'c%' 
union
select top 1 * from #foundmultis where cachename like 'h%' 
union
select top 1 * from #foundmultis where cachename like 'e%' 
;
