...
ALTER TABLE [dbo].[CacheLogs]   ADD  CONSTRAINT [FK_CacheLogs_LogID] FOREIGN KEY([LogId])
...
ALTER TABLE [dbo].[CacheLogs]   ADD  CONSTRAINT [FK_CLCacheID] FOREIGN KEY([CacheId])
