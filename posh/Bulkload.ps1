...
$GPXFiles = .\Get-GPXFromPQs.ps1 -DirWithPQs F:\PQs;
...
foreach ($gpx in $cachefiles) {
	...
	.\import-gpxtodb.ps1 -sqlinstance andrewle-a2981\SQL2014 -Database CacheDB -FileToImport $gpx.filepath;
#.\import-gpxtodb.ps1 -sqlinstance andrewle-a2981\SQL2016ctp33 -Database CacheDB -FileToImport $gpx.filepath;
}
